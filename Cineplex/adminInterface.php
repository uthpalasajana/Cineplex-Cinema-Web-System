 ...
 <header>
     ...
     <section class="home" id="home">
        <div class="content">
            ...
            <span>Welcome to the ultimate destination for movie lovers!</span>
            <p> "Welcome to Cineplex where every visit is a blockbuster event!</p>
...
<!--section class="icons-container">
    <div class="icons">
        <img src="images/the witch.jpg" alt="">
        <div class="info">
            <h3>Free delivery</h3>
...
</br></br></br></br></br><h1 class="heading">Available <span>Movies</span></h1>
    <div class="box-container">
        <div class="box">
            <span class="discount">-10%</span>
            <div class="image">
                <img src="images/mission imposible 7.jpg" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
            ...
            <div class="content">
                ...
                <div class="price">LKR 2250<span>LKR 2500</span></div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Breaking Bad</h3>
                <div class="price">LKR 1785 <span>LKR 2100</span></div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Hobbit</h3>
                <div class="price">LKR 2600 <span>LKR 2850</span></div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Malang</h3>
                <div class="price">LKR 800  <span>LKR 1200</span></div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price">LKR 4650 <span>LKR 5600</span></div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="images/raya the last dragon.jpg" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Buy Now</a>
                    <a href="#" class="fas fa-shopping-cart"></a>
            ...
            <div class="content">
                ...
                <div class="price">LKR 8000 <span>LKR 8500</span></div>
            </div>
        </div>
...
<section class="footer">
    <div class="box-container">
        ...
        <div class="box">
            <h3>contact info</h3>
            <a href="#">+94771550253</a>
            <a href="#">Cineplexcinema@gmail.com</a>
            <a href="#">No:15/1,Kegalle</a>
          <img src="imgs/payment method.png" alt="">
       
        </div>
    </div>
    <div class="credit">
       Cineplex Cinema &copy; 2023 - All Right Reserved 
    </div>
</section>
...
<script src="floraheaven.js"></script>